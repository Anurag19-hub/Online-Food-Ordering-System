                                ...
                                <div class="card">
                                    ...
                                    <div class="card-block">
                                        <div class="row">
                                                ...
                                                <div class="card-block table-border-style">
                                                    <div class="table-responsive">
                                                        <asp:Repeater ID="rOrderStatus" runat="server"
                                                            OnItemCommand="rOrderStatus_ItemCommand">
                                            ...
                                            <div class="col-sm-6 col-md-3 col-lg-3 mobile-inputs">
                                                <asp:Panel ID="pUpdateOrderStatus" runat="server">
                                                    <h4 class="sub-title"> Update Order Status</h4>                                                
                                                <div>
                                                    <div class="form-group">
                                                        ...
                                                        <div>
                                                            ...
                                                            <asp:RequiredFieldValidator ID="rfvDblOrderStatus" runat="server"
                                                               ForeColor="Red" ControlToValidate="ddlOrderStatus"
                                                               ErrorMessage="Order status is required" SetFocusOnError="true"
