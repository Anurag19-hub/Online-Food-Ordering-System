...
namespace Foodie.Client
{
    public partial class Payment : System.Web.UI.Page
    {
        ...
        protected void lbCardSubmit_Click(object sender, EventArgs e)
        {
            ...
            // cardno has 16 num so first 12 num will be display in * manner and last 4 will keep as it is 
        ...
        void OrderPayment(string name, string cardNo, string expiryDate, string cvv, string address, string paymentMode)
        {
            ...
            dt.Columns.AddRange(new DataColumn[7] {
                //It is just a Column Names which don't have any data
            ...
            //we use SqlTransaction because if user get any error during the making the payment. it will check two or
            //three time and if it raise the error then it will control or handle it easily 
            ...
            try
            {
                ...
                while (dr.Read())
                {
                    ...
                    // Delete Cart Item after making the payment Start

                    DeleteCartItem(productId, transaction, con);

                    // Delete Cart Item after making the payment End

                    //This is use to pass the data of that 7 Columns
                ...
                //when any execution and any single execution of credit cards fail will control back that transaction
                //like if user get an error during the execution it will use to handle the error
                try
                {
                    ...
                    Response.Write("<script> alert('"+ e2.Message +"'); </script>");
                }                                               
            }
