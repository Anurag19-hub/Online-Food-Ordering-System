<%@ Page Title="" Language="C#" MasterPageFile="~/Client/Client.Master" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="Foodie.Client.Default" %>
                                ...
                                <div class="box ">
                                    <div class="img-box" style="height:150px;">
                                        ...
                                        <a href="Menu.aspx?id=<%# Eval("CategoryId") %>">
                                            ...
                                            <img src=" <%# Utils.GetImageUrl(Eval("ImageUrl")) %> " style="height:150px;" alt="">
                                        </a>                                        
                                    </div>
