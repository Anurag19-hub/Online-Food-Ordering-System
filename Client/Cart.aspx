<%@ Page Title="" Language="C#" MasterPageFile="~/Client/Client.Master" AutoEventWireup="true" CodeBehind="Cart.aspx.cs" Inherits="Foodie.Client.Cart" %>
            ...
            <asp:Repeater ID="rCartItem" runat="server" OnItemCommand="rCartItem_ItemCommand"
                ...
                <ItemTemplate>
                    <tr>
                        ...
                        <td>
                            <!-- Custom css we have made in style.css file -->
                    ...
                    <tr>
                        <td colspan="2" class="continue__btn">
                            <a href="Menu.aspx" class="btn btn-info">
                                <i class="fa fa-arrow-circle-left mr-2"></i>Continue To Make Order
                            </a>
                        </td>
