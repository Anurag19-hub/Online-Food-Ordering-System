<%@ Page Title="" Language="C#" MasterPageFile="~/Client/Client.Master" AutoEventWireup="true" CodeBehind="Registration.aspx.cs" Inherits="Foodie.Client.Registration" %>
                    ...
                    <div class="form_container">
                        ...
                        <div>                            
                            ...
                            <asp:RegularExpressionValidator ID="revName" runat="server"
                               ErrorMessage="Name must be in characters only" ForeColor="Red"
                        ...
                        <div>                            
                            ...
                            <asp:TextBox ID="txtEmail" runat="server" CssClass="form-control"
                                placeholder="Enter Email" ToolTip="Email" TextMode="Email"></asp:TextBox>
                        </div>
                        ...
                        <div>                            
                            ...
                            <asp:RegularExpressionValidator ID="revMobile" runat="server"
                               ErrorMessage="Mobile Number must have 10 digit" ForeColor="Red"
                               Display="Dynamic" SetFocusOnError="true" 
                    ...
                    <div class="form_container">
                        ...
                        <div>                           
                            ...
                            <asp:RegularExpressionValidator ID="revPostCode" runat="server"
                               ErrorMessage="Post/Zip Code must be of 6 digit" ForeColor="Red"
                               Display="Dynamic" SetFocusOnError="true" 
                             ...
                             <asp:TextBox ID="txtPostCode" runat="server" CssClass="form-control"
                                placeholder="Enter Post/Zip Code" ToolTip="Post/Zip Code" TextMode="Number"></asp:TextBox>
                        </div>
                        ...
                        <div>                                                        
                            <asp:RequiredFieldValidator ID="refPassword" runat="server" ErrorMessage="Password is required"
